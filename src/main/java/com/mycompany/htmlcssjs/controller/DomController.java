...
public class DomController {
	...
	@RequestMapping("/exam03_dom_element_mainpulation")
	public String exam03DomElementMainpulation() {
		log.info("exam03DomElementMainpulation()실행");
		return "dom/exam03_dom_element_mainpulation";
	}
