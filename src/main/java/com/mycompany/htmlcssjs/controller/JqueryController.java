...
public class JqueryController {
	...
	@RequestMapping("/exam03_jquery_element_mainpulation")
	public String exam03JqueryElementMainpulation() {
		log.info("exam03JqueryElementMainpulation() 실행");
		return "jquery/exam03_jquery_element_mainpulation";
	}
