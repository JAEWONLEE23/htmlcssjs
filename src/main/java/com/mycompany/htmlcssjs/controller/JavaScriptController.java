...
public class JavaScriptController {
		@RequestMapping("")  //method를 이용한 requsetmapping 이다.
		public String index() {
			log.info("index()실행");
		...
		@RequestMapping("/exam07_getter_settter")  
		public String exam07GetterSettter() {
			log.info("exam07GetterSettter()실행");
			return "javascript/exam07_getter_settter";
		}	
