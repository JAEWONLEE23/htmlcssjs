	...
	<body>
		...
		<div class="card">
 		...
 		<ul>
 			...
 			<li><a href="javascript/exam06_dynamic_field_method">exam06_dynamic_field_method</a></li>
 			<li><a href="javascript/exam07_getter_settter">exam07_getter_settter</a></li>
