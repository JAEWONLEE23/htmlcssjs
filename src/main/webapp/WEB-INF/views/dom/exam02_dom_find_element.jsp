	...
	<head>
		...
		<script>
			function findElementById() {
				...
				console.log(el_p1);
				//방법2
				el_p1 =document.querySelector("#p1");//getElementById 보다 다양하게 사용가능
				console.log(el_p1);
			}	
			
			function findElementByClass() {
				//방법1
				 var el_class1 = document.getElementsByClassName("class1"); //HTMLCollection 타입
				console.log(el_class1);
				console.log(el_class1[0]); //배열은 아니지만 배열처럼 사용할수가 있다.
				for(var el of el_class1) {
					console.log(el);
				}
				console.log("");
				//방법2
				el_class1 = document.querySelectorAll(".class1"); // 두개이상을 가져올경우는document.querySelectoAll 로 바꿔야된다// NodeList 타입리턴
				console.log(el_class1);
